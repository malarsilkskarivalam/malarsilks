...
async function setupUsers() {
  try {
    ...
    await client.query('DELETE FROM users WHERE email IN ($1, $2)', ['poungracy@gmail.com', 'user@example.com']);

    // Insert Admin
    await client.query(`
      INSERT INTO users (name, email, password, role, city) 
      VALUES ($1, $2, $3, $4, $5)
    `, ['Admin User', 'poungracy@gmail.com', adminPassword, 'admin', 'Chennai']);
    ...
    console.log('Admin: poungracy@gmail.com / Malarsilks@2026');
