...
const seedAdmin = async (req, res) => {
    try {
        ...
        const result = await pool.query('SELECT * FROM admins WHERE email = $1', ['poungracy@gmail.com']);
        ...
        await pool.query('INSERT INTO admins (email, password) VALUES ($1, $2)', ['poungracy@gmail.com', hashedPassword]);
...
const deleteAdmin = async (req, res) => {
    try {
        ...
        if (admin.email === 'poungracy@gmail.com') {
