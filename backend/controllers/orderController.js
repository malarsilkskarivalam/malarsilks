...
const sendSMSNotification = require('../utils/sendSMS');
...
const createOrder = async (req, res) => {
    try {
        ...
        // Asynchronously send notifications (don't block the response)
        sendSMSNotification(completeOrder).catch(err => console.error("SMS error:", err));
